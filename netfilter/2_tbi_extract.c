...
static int check_proc_show(struct seq_file *m, void *v) 
{
	seq_printf(m, "hello world!\n");
	return 0;
}
static int check_proc_open(struct inode* inode, struct file* file)
{
	return single_open(file, check_proc_show, NULL);
}

static const struct file_operations check_proc_fops = {
	.open = check_proc_open,
	.read = seq_read,
	.llseek = seq_lseek,
